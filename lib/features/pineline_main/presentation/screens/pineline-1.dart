...
import 'package:flutter_application_latn/features/pineline_main/presentation/screens/skin_description_screen.dart';

class Pineline_1_Screen extends StatefulWidget {
  @override
  _Pineline_1_ScreenState createState() => _Pineline_1_ScreenState();
}

class _Pineline_1_ScreenState extends State<Pineline_1_Screen> {
                        ...
                        showModalBottomSheet(
                          ...
                          builder: (context) => DraggableScrollableSheet(
                            ...
                            builder: (context, scrollController) {
                              return SkinDescriptionForm(scrollController: scrollController);
                            },
                          ),
                        );
                      },
